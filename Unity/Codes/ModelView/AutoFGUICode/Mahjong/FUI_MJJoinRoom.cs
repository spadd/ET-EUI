...
namespace ET
{
    public class FUI_MJJoinRoom : Entity,IAwake,IAwake<GObject>,IDestroy
    {
        public const string UIPackageName = "Mahjong";
        public const string UIResName = "MJJoinRoom";
        public const string URL = "ui://wtxqw9t3k5s1f3";
        ...
        public static FUI_MJJoinRoom CreateInstance(Entity domain)
        {
            return domain.AddChild<FUI_MJJoinRoom, GObject>(CreateGObject());
        }

        public static async ETTask<FUI_MJJoinRoom> CreateInstanceAsync(Entity domain)
        {
            ETTask<FUI_MJJoinRoom> tcs = ETTask<FUI_MJJoinRoom>.Create(true);
            CreateGObjectAsync((go) =>
            {
                tcs.SetResult(domain.AddChild<FUI_MJJoinRoom, GObject>(go));
            });
            return await tcs;
        }
